...
const I18N = {
  ko: {
    ...
    /* 검색 로딩 문구 랜덤 풀 — getRandomSearching() 이 매번 하나를 뽑아서 반환 */
    searching1: '단어를 소환 중...',
    searching2: '단어의 별자리를 그리는 중...',
    searching3: '단어의 빛을 모으는 중...',
    searching4: '단어 속 세계를 탐험하는 중...',
    searching5: '단어에 숨결을 불어넣는 중...',
...
예시: split, break down, take off`,
  ...
  en: {
    ...
    searching2: "Tracing the word's constellation...",
    searching3: "Gathering the word's light...",
    searching4: 'Exploring the world within the word...',
    searching5: 'Breathing life into the word...',
...
Example: split, break down, take off`,
  ...
  ja: {
    ...
    searching1: '単語を召喚中...',
    searching2: '単語の星座を描いています...',
    searching3: '単語の光を集めています...',
    searching4: '単語の中の世界を探検しています...',
    searching5: '単語に息を吹き込んでいます...',
    imageLoading: '画像を生成中...',
...
例：split, break down, take off`,
  ...
  zh: {
    ...
    searching1: '正在召唤单词...',
    searching2: '正在描绘单词的星座...',
    searching3: '正在收集单词的光芒...',
    searching4: '正在探索单词中的世界...',
    searching5: '正在为单词注入生命...',
    imageLoading: '正在生成图片...',
...
示例：split, break down, take off`,
  ...
  es: {
    ...
    searching2: 'Trazando la constelación de la palabra...',
    searching3: 'Recogiendo la luz de la palabra...',
    searching4: 'Explorando el mundo dentro de la palabra...',
    searching5: 'Dando vida a la palabra...',
...
Ejemplo: split, break down, take off`,
  ...
  vi: {
    ...
    searching2: 'Đang vẽ chòm sao của từ...',
    searching3: 'Đang thu thập ánh sáng của từ...',
    searching4: 'Đang khám phá thế giới bên trong từ...',
    searching5: 'Đang thổi hồn vào từ...',
...
Ví dụ: split, break down, take off`,
  ...
  th: {
    ...
    searching2: 'กำลังวาดกลุ่มดาวของคำ...',
    searching3: 'กำลังรวบรวมแสงของคำ...',
    searching4: 'กำลังสำรวจโลกภายในคำ...',
    searching5: 'กำลังเป่าลมหายใจให้คำ...',
...
ตัวอย่าง: split, break down, take off`,
  ...
  pt: {
    ...
    searching2: 'Traçando a constelação da palavra...',
    searching3: 'Reunindo a luz da palavra...',
    searching4: 'Explorando o mundo dentro da palavra...',
    searching5: 'Dando vida à palavra...',
...
/* 검색 로딩 문구 랜덤 선택 — searching1 ~ searching5 풀에서 매번 다른 문구 반환
   같은 세션에서 여러 번 검색해도 매 검색마다 다른 문구가 보이도록. */
function getRandomSearching() {
  const idx = Math.floor(Math.random() * 5) + 1;
  return t('searching' + idx);
}
