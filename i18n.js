...
const I18N = {
  ko: {
    ...
    /* 추출 실패 페이지 발견 배너 — {pages} 자리에 "3, 7, 9" 같은 1-indexed 페이지 번호가 들어감 */
    readingPagesExtractFailed: '{pages}페이지 추출 실패',
    readingRetryAll: '모두 재시도',
  ...
  en: {
    ...
    readingPagesExtractFailed: 'Pages {pages} failed to extract',
    readingRetryAll: 'Retry all',
  ...
  ja: {
    ...
    readingPagesExtractFailed: '{pages}ページの抽出に失敗',
    readingRetryAll: 'すべて再試行',
  ...
  zh: {
    ...
    readingPagesExtractFailed: '第 {pages} 页提取失败',
    readingRetryAll: '全部重试',
  ...
  es: {
    ...
    readingPagesExtractFailed: 'No se pudieron extraer las páginas {pages}',
    readingRetryAll: 'Reintentar todo',
  ...
  vi: {
    ...
    readingPagesExtractFailed: 'Không thể trích xuất trang {pages}',
    readingRetryAll: 'Thử lại tất cả',
  ...
  th: {
    ...
    readingPagesExtractFailed: 'หน้า {pages} แยกไม่สำเร็จ',
    readingRetryAll: 'ลองใหม่ทั้งหมด',
  ...
  pt: {
    ...
    readingPagesExtractFailed: 'Falha ao extrair as páginas {pages}',
    readingRetryAll: 'Tentar todas novamente',
