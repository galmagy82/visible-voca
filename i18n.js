...
const I18N = {
  ko: {
    ...
    tabQuiz: '퀴즈',
    tabMyRecord: '내 기록',
    myrecordCharacter: '내 캐릭터',
    myrecordSettings: '설정',
    myrecordLevel: 'Lv. —',
    myrecordComingSoon: '준비중',
    settingsAutoAdd: '검색 시 단어장에 바로 추가',
    settingsImageStyle: '그림 스타일',
    settingsImageText: '그림에 넣을 말',
...
예시: split, break down, take off`,
  ...
  en: {
    ...
    tabQuiz: 'Quiz',
    tabMyRecord: 'My Record',
    myrecordCharacter: 'My Character',
    myrecordSettings: 'Settings',
    myrecordLevel: 'Lv. —',
    myrecordComingSoon: 'Coming soon',
    settingsAutoAdd: 'Auto-add to wordbook on search',
    settingsImageStyle: 'Image style',
    settingsImageText: 'Text on image',
...
Example: split, break down, take off`,
  ...
  ja: {
    ...
    tabQuiz: 'クイズ',
    tabMyRecord: 'マイ記録',
    myrecordCharacter: 'マイキャラ',
    myrecordSettings: '設定',
    myrecordLevel: 'Lv. —',
    myrecordComingSoon: '準備中',
    settingsAutoAdd: '検索時に単語帳へ自動追加',
    settingsImageStyle: 'イラストスタイル',
    settingsImageText: 'イラストに入れる言葉',
...
例：split, break down, take off`,
  ...
  zh: {
    ...
    tabQuiz: '测验',
    tabMyRecord: '我的记录',
    myrecordCharacter: '我的角色',
    myrecordSettings: '设置',
    myrecordLevel: 'Lv. —',
    myrecordComingSoon: '即将推出',
    settingsAutoAdd: '搜索时自动添加到单词本',
    settingsImageStyle: '图片风格',
    settingsImageText: '图片上的文字',
...
示例：split, break down, take off`,
  ...
  es: {
    ...
    tabQuiz: 'Quiz',
    tabMyRecord: 'Mi registro',
    myrecordCharacter: 'Mi personaje',
    myrecordSettings: 'Ajustes',
    myrecordLevel: 'Nv. —',
    myrecordComingSoon: 'Próximamente',
    settingsAutoAdd: 'Agregar al vocabulario al buscar',
    settingsImageStyle: 'Estilo de imagen',
    settingsImageText: 'Texto en la imagen',
...
ตัวอย่าง: split, break down, take off`,
  ...
  pt: {
    ...
    tabWordbook: 'Caderno',
    tabQuiz: 'Quiz',
    tabMyRecord: 'Meu registro',
    myrecordCharacter: 'Meu personagem',
    myrecordSettings: 'Configurações',
    myrecordLevel: 'Nv. —',
    myrecordComingSoon: 'Em breve',
    settingsAutoAdd: 'Adicionar ao caderno ao buscar',
    settingsImageStyle: 'Estilo de imagem',
    settingsImageText: 'Texto na imagem',
