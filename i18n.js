...
const I18N = {
  ko: {
    ...
    /* 검색 결과 추천/비추천 클릭 후 토스트 — 추천은 짧게, 비추천은 운영자 신뢰감 메시지 */
    voteUpThanks: '피드백 감사합니다.',
    voteDownThanks: '피드백 감사합니다. 검토 후 개선될 예정이에요.',
    ...
    wbSets: '세트',
    wbBooks: '📚 My Books 단어',
    wbBooksEmpty: '아직 저장한 책이 없어요',
    wbBookNoStudyItems: '이 책에는 학습 단어가 없어요',
    wbBooksBackToList: '← 책 목록',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ 인쇄',
    setBackToList: '← 세트 목록',
    ...
    quizMyBooksBackToMode: '← 모드 선택',
    quizMyBooksDesc: '단어 풀을 선택하세요',
    quizMyBooksTooFew: '단어가 너무 적어요 (4개 이상 필요)',
    quizMyBooksGuess: '단어를 맞춰보세요',
    quizType: '유형',
    quizTypeFeel: '느낌 맞추기',
    ...
    quizScope: '출제 범위',
    quizScopeAll: '전체',
    quizScopeRecent7: '최근 7일',
    quizScopeRecent30: '최근 30일',
    quizStart: '퀴즈 시작',
    quizNext: '다음',
    quizResult: '퀴즈 결과',
    quizRetry: '다시 하기',
    ...
    feedback: '의견 보내기',
    aboutLink: '소개',
    guestEntry: 'Guest 로 둘러보기 →',
    guestStartFailed: 'Guest 체험 시작에 실패했어요. 잠시 후 다시 시도해 주세요.',
    adLabel: '광고',
    ...
    readingPhotoCaption: '한 페이지씩 찍어주세요',
    readingUploadBtn: '📂 책 사진 올리기',
    readingUploadHint: '앞페이지부터 사진을 한꺼번에 올려주세요.\n선택한 순서대로 페이지가 됩니다.',
    readingGuestSampleIntro: '책사진이 없으세요?',
    readingGuestSample1: '📥 체험용 사진 1',
    readingGuestSample2: '📥 체험용 사진 2',
    readingExtracting: '텍스트 추출 중...',
    /* 2-phase 파이프라인 단계 라벨 — phase 1: OCR / phase 2: 페이지 경계 정리 / phase 3: 번역+학습단어. */
    readingPhaseExtract: '텍스트 추출 중...',
    readingPhaseStitch: '페이지 정리 중...',
    readingPhaseTranslate: '학습자료 생성 중...',
    readingLoadingGuide: '처리가 끝날 때까지 다른 화면으로 이동하지 마세요',
    readingTranslate: '번역',
    readingShowOriginal: '원문',
    readingMaxPagesAlert: '한 번에 최대 30페이지까지 업로드 가능합니다.',
    /* 크레딧 잔액 부족 안내 — Reading 사진 업로드 사전 체크에서 표시. {balance}, {needed} 자리 치환. */
    creditInsufficient: '🪙 크레딧이 부족합니다.\n현재 잔액: {balance}\n필요한 크레딧: {needed}',
    readingNoText: '이 페이지에는 글자가 없습니다.',
    readingPageError: '이 페이지의 텍스트를 추출하지 못했습니다.',
    readingRetryPage: '다시 시도',
    readingReplacePhoto: '다른 사진으로 교체',
    readingRetryingPage: '재시도 중...',
    /* 추출 실패 모달 — readingExtractFailedDesc 의 {pages} 자리에 "3, 7, 9" 같은 1-indexed 번호 치환 */
    readingExtractFailedTitle: '추출 실패',
    readingExtractFailedDesc: '{pages}페이지의 텍스트를 추출하지 못했습니다.',
    readingRetryAll: '재시도',
    ...
    readingSaveBookBtn: '📚 책으로 저장',
    readingReorderPagesBtn: '🔀 순서 편집',
    readingReorderModalTitle: '페이지 순서 편집',
    readingReorderModalDesc: '↑↓ 버튼으로 페이지 순서를 바꿀 수 있어요',
    readingReorderSaveError: '순서 변경 저장에 실패했어요',
    readingSavedIndicator: '저장된 책',
    readingSaveBookTitle: '책 저장하기',
    readingSaveBookDesc: '이 책의 제목을 입력하세요',
    /* 자동 저장 도입 후 신규 — 추출 직후 토스트 + 저장된 책의 제목 변경 모드 라벨. */
    readingAutoSavedToast: 'My Books에 자동저장되었어요.',
    readingRenameBookBtn: '✏️ 책 제목 붙이기',
    readingRenameBookTitle: '책 제목 붙이기',
    readingSaveBookPlaceholder: '예: 어린왕자 1장',
    readingFolderLabel: '폴더',
    readingFolderNone: '폴더 없음',
    readingFolderCreateNew: '+ 새 폴더 만들기',
    readingFolderNamePlaceholder: '새 폴더 이름',
    readingFolderBookCount: '{n} 챕터',
    readingFolderBack: '← My Books',
    readingFolderEmpty: '이 폴더에 아직 챕터가 없어요',
    readingMoveBookTitle: '폴더로 이동',
    readingMoveBookBtn: '이동',
    readingBookCardPages: '{n}페이지',
    readingDeleteBookConfirm: '이 책을 삭제하시겠습니까?',
    readingDeleteFolderTitle: '폴더 삭제',
    readingDeleteFolderBtn: '삭제',
    readingDeleteFolderEmptyDesc: '폴더 "{name}" 을(를) 삭제할까요?',
    readingDeleteFolderHasBooksDesc: '폴더 "{name}" 에 챕터 {n}개가 있어요. 어떻게 할까요?',
    readingDeleteFolderKeepBooks: '폴더만 삭제',
    readingDeleteFolderWithBooks: '챕터도 함께 삭제',
    readingDeleteFolderError: '폴더 삭제에 실패했어요',
    readingStudyItemsTitle: '이 페이지의 학습 단어 ({n})',
    readingNoStudyItems: '이 페이지에는 학습 단어가 없어요',
    readingLoadingBooks: '책 목록을 불러오는 중...',
  ...
  en: {
    ...
    voteUpThanks: 'Thanks for your feedback.',
    voteDownThanks: 'Thanks for your feedback. We\'ll review and improve it.',
    ...
    wbVocab: 'Words',
    wbSets: 'Sets',
    wbBooks: '📚 My Books Words',
    wbBooksEmpty: 'No saved books yet',
    wbBookNoStudyItems: 'No study words in this book',
    wbBooksBackToList: '← Back to books',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ Print',
    ...
    quizMyBooksBackToMode: '← Mode',
    quizMyBooksDesc: 'Pick a word pool',
    quizMyBooksTooFew: 'Not enough words (need at least 4)',
    quizMyBooksGuess: 'Guess the word',
    quizType: 'Type',
    ...
    quizScope: 'Range',
    quizScopeAll: 'All',
    quizScopeRecent7: 'Last 7 days',
    quizScopeRecent30: 'Last 30 days',
    ...
    guestStartFailed: 'Failed to start guest mode. Please try again in a moment.',
    ...
    readingPhotoCaption: 'Photograph one page at a time',
    readingUploadBtn: '📂 Upload book photos',
    readingUploadHint: 'Upload all photos at once, in page order.\nPages follow your selection order.',
    readingGuestSampleIntro: 'No book photo?',
    readingGuestSample1: '📥 Sample photo 1',
    readingGuestSample2: '📥 Sample photo 2',
    readingExtracting: 'Extracting text...',
    readingPhaseExtract: 'Extracting text...',
    readingPhaseStitch: 'Tidying page boundaries...',
    readingPhaseTranslate: 'Generating study materials...',
    readingLoadingGuide: 'Please stay on this screen until processing is complete',
    readingTranslate: 'Translate',
    readingShowOriginal: 'Original',
    readingMaxPagesAlert: 'You can upload up to 30 pages at once.',
    creditInsufficient: '🪙 Not enough credits.\nCurrent balance: {balance}\nRequired: {needed}',
    readingNoText: 'No readable text on this page.',
    readingPageError: 'Failed to extract text from this page.',
    readingRetryPage: 'Retry',
    readingReplacePhoto: 'Replace photo',
    readingRetryingPage: 'Retrying...',
    readingExtractFailedTitle: 'Extraction failed',
    readingExtractFailedDesc: 'Could not extract text from pages {pages}.',
    readingRetryAll: 'Retry',
    ...
    readingSaveBookBtn: '📚 Save as book',
    readingReorderPagesBtn: '🔀 Reorder',
    readingReorderModalTitle: 'Reorder pages',
    readingReorderModalDesc: 'Use ↑↓ to change page order',
    readingReorderSaveError: 'Failed to save the new page order',
    readingSavedIndicator: 'Saved book',
    readingSaveBookTitle: 'Save book',
    readingSaveBookDesc: 'Enter a title for this book',
    readingAutoSavedToast: 'Auto-saved to My Books.',
    readingRenameBookBtn: '✏️ Name this book',
    readingRenameBookTitle: 'Name this book',
    readingSaveBookPlaceholder: 'e.g. The Little Prince Ch.1',
    readingFolderLabel: 'Folder',
    readingFolderNone: 'No folder',
    readingFolderCreateNew: '+ Create new folder',
    readingFolderNamePlaceholder: 'New folder name',
    readingFolderBookCount: '{n} chapters',
    readingFolderBack: '← My Books',
    readingFolderEmpty: 'This folder is empty',
    readingMoveBookTitle: 'Move to folder',
    readingMoveBookBtn: 'Move',
    readingBookCardPages: '{n} pages',
    readingDeleteBookConfirm: 'Delete this book?',
    readingDeleteFolderTitle: 'Delete folder',
    readingDeleteFolderBtn: 'Delete',
    readingDeleteFolderEmptyDesc: 'Delete folder "{name}"?',
    readingDeleteFolderHasBooksDesc: 'Folder "{name}" contains {n} chapter(s). What do you want to do?',
    readingDeleteFolderKeepBooks: 'Delete folder only',
    readingDeleteFolderWithBooks: 'Delete folder and chapters',
    readingDeleteFolderError: 'Failed to delete folder',
    readingStudyItemsTitle: 'Study items on this page ({n})',
    readingNoStudyItems: 'No study items on this page',
    readingLoadingBooks: 'Loading books...',
  ...
  ja: {
    ...
    imageLoading: '画像を生成中...',
    voteUpThanks: 'フィードバックありがとうございます。',
    voteDownThanks: 'フィードバックありがとうございます。確認の上、改善する予定です。',
    ...
    wbSets: 'セット',
    wbBooks: '📚 My Books 単語',
    wbBooksEmpty: 'まだ保存した本はありません',
    wbBookNoStudyItems: 'この本には学習単語がありません',
    wbBooksBackToList: '← 本一覧',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ 印刷',
    setBackToList: '← セット一覧',
    ...
    quizMyBooksBackToMode: '← モード選択',
    quizMyBooksDesc: '単語プールを選んでください',
    quizMyBooksTooFew: '単語が少なすぎます (4 つ以上必要)',
    quizMyBooksGuess: '単語を当ててください',
    quizType: 'タイプ',
    quizTypeFeel: '感覚当て',
    quizTypeImage: '画像当て',
    quizCount: '問題数',
    ...
    quizScope: '出題範囲',
    quizScopeAll: 'すべて',
    quizScopeRecent7: '直近7日',
    quizScopeRecent30: '直近30日',
    quizStart: 'クイズ開始',
    quizNext: '次へ',
    quizResult: 'クイズ結果',
    quizRetry: 'もう一度',
    ...
    aboutLink: '紹介',
    guestEntry: 'ゲストで体験 →',
    guestStartFailed: 'ゲスト体験の開始に失敗しました。少し時間をおいて再度お試しください。',
    adLabel: '広告',
    ...
    readingPhotoCaption: '1ページずつ撮影してください',
    readingUploadBtn: '📂 本の写真をアップロード',
    readingUploadHint: 'ページ順に写真を一度にアップロードしてください。\n選択順にページが決まります。',
    readingGuestSampleIntro: '本の写真がありませんか?',
    readingGuestSample1: '📥 サンプル写真 1',
    readingGuestSample2: '📥 サンプル写真 2',
    readingExtracting: 'テキストを抽出中...',
    readingPhaseExtract: 'テキストを抽出中...',
    readingPhaseStitch: 'ページの境界を整理中...',
    readingPhaseTranslate: '学習資料を生成中...',
    readingLoadingGuide: '処理が終わるまで他の画面に移動しないでください',
    readingTranslate: '翻訳',
    readingShowOriginal: '原文',
    readingMaxPagesAlert: '一度に最大30ページまでアップロードできます。',
    creditInsufficient: '🪙 クレジットが不足しています。\n現在の残高: {balance}\n必要なクレジット: {needed}',
    readingNoText: 'このページにテキストはありません。',
    readingPageError: 'このページのテキストを抽出できませんでした。',
    readingRetryPage: '再試行',
    readingReplacePhoto: '別の写真に差し替え',
    readingRetryingPage: '再試行中...',
    readingExtractFailedTitle: '抽出失敗',
    readingExtractFailedDesc: '{pages}ページのテキストを抽出できませんでした。',
    readingRetryAll: '再試行',
    ...
    readingSaveBookBtn: '📚 本として保存',
    readingReorderPagesBtn: '🔀 順序編集',
    readingReorderModalTitle: 'ページの順序を編集',
    readingReorderModalDesc: '↑↓ ボタンでページの順序を変えられます',
    readingReorderSaveError: '順序の変更を保存できませんでした',
    readingSavedIndicator: '保存された本',
    readingSaveBookTitle: '本を保存',
    readingSaveBookDesc: 'この本のタイトルを入力してください',
    readingAutoSavedToast: 'My Booksに自動保存されました。',
    readingRenameBookBtn: '✏️ タイトルをつける',
    readingRenameBookTitle: 'タイトルをつける',
    readingSaveBookPlaceholder: '例: 星の王子さま 第1章',
    readingFolderLabel: 'フォルダ',
    readingFolderNone: 'フォルダなし',
    readingFolderCreateNew: '+ 新規フォルダ',
    readingFolderNamePlaceholder: '新しいフォルダ名',
    readingFolderBookCount: '{n} チャプター',
    readingFolderBack: '← My Books',
    readingFolderEmpty: 'このフォルダはまだ空です',
    readingMoveBookTitle: 'フォルダへ移動',
    readingMoveBookBtn: '移動',
    readingBookCardPages: '{n}ページ',
    readingDeleteBookConfirm: 'この本を削除しますか?',
    readingDeleteFolderTitle: 'フォルダを削除',
    readingDeleteFolderBtn: '削除',
    readingDeleteFolderEmptyDesc: 'フォルダ「{name}」を削除しますか?',
    readingDeleteFolderHasBooksDesc: 'フォルダ「{name}」にチャプターが{n}個あります。どうしますか?',
    readingDeleteFolderKeepBooks: 'フォルダのみ削除',
    readingDeleteFolderWithBooks: 'チャプターも一緒に削除',
    readingDeleteFolderError: 'フォルダの削除に失敗しました',
    readingStudyItemsTitle: 'このページの学習アイテム ({n})',
    readingNoStudyItems: 'このページには学習アイテムがありません',
    readingLoadingBooks: '本のリストを読み込み中...',
  ...
  zh: {
    ...
    imageLoading: '正在生成图片...',
    voteUpThanks: '感谢您的反馈。',
    voteDownThanks: '感谢您的反馈。我们将在审核后进行改进。',
    ...
    wbSets: '词组',
    wbBooks: '📚 My Books 单词',
    wbBooksEmpty: '还没有保存的书',
    wbBookNoStudyItems: '这本书没有学习单词',
    wbBooksBackToList: '← 返回书籍列表',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ 打印',
    setBackToList: '← 词组列表',
    setEmpty: '该词组中没有单词。',
    ...
    quizMyBooksBackToMode: '← 模式选择',
    quizMyBooksDesc: '请选择单词池',
    quizMyBooksTooFew: '单词太少 (至少需要 4 个)',
    quizMyBooksGuess: '请猜单词',
    quizType: '类型',
    quizTypeFeel: '猜感觉',
    quizTypeImage: '看图猜词',
    quizCount: '题数',
    ...
    quizScope: '出题范围',
    quizScopeAll: '全部',
    quizScopeRecent7: '最近7天',
    quizScopeRecent30: '最近30天',
    quizStart: '开始测验',
    quizNext: '下一题',
    quizResult: '测验结果',
    quizRetry: '再试一次',
    ...
    aboutLink: '关于',
    guestEntry: '以访客身份体验 →',
    guestStartFailed: '访客模式启动失败,请稍后再试。',
    adLabel: '广告',
    ...
    readingPhotoCaption: '请一次拍一页',
    readingUploadBtn: '📂 上传书页照片',
    readingUploadHint: '请按页面顺序一次性上传所有照片。\n按选择顺序排列为页面。',
    readingGuestSampleIntro: '没有书的照片?',
    readingGuestSample1: '📥 示例图片 1',
    readingGuestSample2: '📥 示例图片 2',
    readingExtracting: '正在提取文本...',
    readingPhaseExtract: '正在提取文本...',
    readingPhaseStitch: '正在整理页面边界...',
    readingPhaseTranslate: '正在生成学习资料...',
    readingLoadingGuide: '处理完成前请勿切换到其他页面',
    readingTranslate: '翻译',
    readingShowOriginal: '原文',
    ...
    readingRetryPage: '重试',
    readingReplacePhoto: '换一张照片',
    readingRetryingPage: '重试中...',
    readingExtractFailedTitle: '提取失败',
    readingExtractFailedDesc: '无法提取第 {pages} 页的文本。',
    readingRetryAll: '重试',
    ...
    readingSaveBookBtn: '📚 保存为书籍',
    readingReorderPagesBtn: '🔀 调整顺序',
    readingReorderModalTitle: '调整页面顺序',
    readingReorderModalDesc: '使用 ↑↓ 按钮来调整页面顺序',
    readingReorderSaveError: '保存新页面顺序失败',
    readingSavedIndicator: '已保存的书',
    readingSaveBookTitle: '保存书籍',
    readingSaveBookDesc: '请为这本书输入标题',
    readingAutoSavedToast: '已自动保存到 My Books。',
    readingRenameBookBtn: '✏️ 给本书命名',
    readingRenameBookTitle: '给本书命名',
    readingSaveBookPlaceholder: '例: 小王子 第1章',
    readingFolderLabel: '文件夹',
    readingFolderNone: '无文件夹',
    readingFolderCreateNew: '+ 新建文件夹',
    readingFolderNamePlaceholder: '新文件夹名称',
    readingFolderBookCount: '{n} 章',
    readingFolderBack: '← My Books',
    readingFolderEmpty: '这个文件夹还没有章节',
    readingMoveBookTitle: '移到文件夹',
    readingMoveBookBtn: '移动',
    readingBookCardPages: '{n}页',
    readingDeleteBookConfirm: '确定要删除这本书吗?',
    readingDeleteFolderTitle: '删除文件夹',
    readingDeleteFolderBtn: '删除',
    readingDeleteFolderEmptyDesc: '删除文件夹"{name}"吗?',
    readingDeleteFolderHasBooksDesc: '文件夹"{name}"包含{n}个章节。如何处理?',
    readingDeleteFolderKeepBooks: '仅删除文件夹',
    readingDeleteFolderWithBooks: '同时删除章节',
    readingDeleteFolderError: '删除文件夹失败',
    readingStudyItemsTitle: '本页学习单词 ({n})',
    readingNoStudyItems: '本页没有学习单词',
    readingLoadingBooks: '正在加载书籍列表...',
  ...
  es: {
    ...
    voteUpThanks: 'Gracias por tu comentario.',
    voteDownThanks: 'Gracias por tu comentario. Lo revisaremos y mejoraremos.',
    ...
    wbVocab: 'Palabras',
    wbSets: 'Conjuntos',
    wbBooks: '📚 My Books Palabras',
    wbBooksEmpty: 'Aún no hay libros guardados',
    wbBookNoStudyItems: 'No hay palabras de estudio en este libro',
    wbBooksBackToList: '← Volver a libros',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ Imprimir',
    ...
    quizMyBooksBackToMode: '← Modo',
    quizMyBooksDesc: 'Selecciona un grupo de palabras',
    quizMyBooksTooFew: 'Pocas palabras (se necesitan al menos 4)',
    quizMyBooksGuess: 'Adivina la palabra',
    quizType: 'Tipo',
    ...
    quizScope: 'Rango',
    quizScopeAll: 'Todo',
    quizScopeRecent7: 'Últimos 7 días',
    quizScopeRecent30: 'Últimos 30 días',
    ...
    aboutLink: 'Acerca de',
    guestEntry: 'Continuar como invitado →',
    guestStartFailed: 'No se pudo iniciar el modo invitado. Inténtalo de nuevo en un momento.',
    adLabel: 'Publicidad',
    ...
    readingPhotoCaption: 'Fotografía una página a la vez',
    readingUploadBtn: '📂 Subir fotos del libro',
    readingUploadHint: 'Sube todas las fotos a la vez, en orden de páginas.\nLas páginas siguen el orden en que las seleccionas.',
    readingGuestSampleIntro: '¿Sin foto de libro?',
    readingGuestSample1: '📥 Foto de muestra 1',
    readingGuestSample2: '📥 Foto de muestra 2',
    readingExtracting: 'Extrayendo texto...',
    readingPhaseExtract: 'Extrayendo texto...',
    readingPhaseStitch: 'Ordenando los límites de página...',
    readingPhaseTranslate: 'Generando material de estudio...',
    readingLoadingGuide: 'Por favor, no salgas de esta pantalla hasta que finalice el proceso',
    readingTranslate: 'Traducir',
    readingShowOriginal: 'Original',
    readingMaxPagesAlert: 'Puedes subir hasta 30 páginas a la vez.',
    creditInsufficient: '🪙 Créditos insuficientes.\nSaldo actual: {balance}\nRequeridos: {needed}',
    readingNoText: 'No hay texto legible en esta página.',
    readingPageError: 'No se pudo extraer el texto de esta página.',
    readingRetryPage: 'Reintentar',
    readingReplacePhoto: 'Reemplazar foto',
    readingRetryingPage: 'Reintentando...',
    readingExtractFailedTitle: 'Extracción fallida',
    readingExtractFailedDesc: 'No se pudo extraer el texto de las páginas {pages}.',
    readingRetryAll: 'Reintentar',
    ...
    readingSaveBookBtn: '📚 Guardar como libro',
    readingReorderPagesBtn: '🔀 Reordenar',
    readingReorderModalTitle: 'Reordenar páginas',
    readingReorderModalDesc: 'Usa ↑↓ para cambiar el orden de las páginas',
    readingReorderSaveError: 'No se pudo guardar el nuevo orden',
    readingSavedIndicator: 'Libro guardado',
    readingSaveBookTitle: 'Guardar libro',
    readingSaveBookDesc: 'Introduce un título para este libro',
    readingAutoSavedToast: 'Guardado automáticamente en My Books.',
    readingRenameBookBtn: '✏️ Nombrar este libro',
    readingRenameBookTitle: 'Nombrar este libro',
    readingSaveBookPlaceholder: 'ej. El Principito Cap.1',
    readingFolderLabel: 'Carpeta',
    readingFolderNone: 'Sin carpeta',
    readingFolderCreateNew: '+ Crear carpeta nueva',
    readingFolderNamePlaceholder: 'Nombre de la carpeta',
    readingFolderBookCount: '{n} capítulos',
    readingFolderBack: '← My Books',
    readingFolderEmpty: 'Esta carpeta está vacía',
    readingMoveBookTitle: 'Mover a carpeta',
    readingMoveBookBtn: 'Mover',
    readingBookCardPages: '{n} páginas',
    readingDeleteBookConfirm: '¿Eliminar este libro?',
    readingDeleteFolderTitle: 'Eliminar carpeta',
    readingDeleteFolderBtn: 'Eliminar',
    readingDeleteFolderEmptyDesc: '¿Eliminar la carpeta "{name}"?',
    readingDeleteFolderHasBooksDesc: 'La carpeta "{name}" contiene {n} capítulo(s). ¿Qué hacer?',
    readingDeleteFolderKeepBooks: 'Eliminar solo la carpeta',
    readingDeleteFolderWithBooks: 'Eliminar carpeta y capítulos',
    readingDeleteFolderError: 'No se pudo eliminar la carpeta',
    readingStudyItemsTitle: 'Elementos de estudio en esta página ({n})',
    readingNoStudyItems: 'No hay elementos de estudio en esta página',
    readingLoadingBooks: 'Cargando libros...',
  ...
  vi: {
    ...
    voteUpThanks: 'Cảm ơn phản hồi của bạn.',
    voteDownThanks: 'Cảm ơn phản hồi của bạn. Chúng tôi sẽ xem xét và cải thiện.',
    ...
    wbSets: 'Bộ từ',
    wbBooks: '📚 My Books Từ',
    wbBooksEmpty: 'Chưa có sách đã lưu',
    wbBookNoStudyItems: 'Sách này chưa có từ học',
    wbBooksBackToList: '← Quay lại danh sách',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ In',
    ...
    quizMyBooksBackToMode: '← Chế độ',
    quizMyBooksDesc: 'Chọn nhóm từ',
    quizMyBooksTooFew: 'Chưa đủ từ (cần ít nhất 4)',
    quizMyBooksGuess: 'Đoán từ này',
    quizType: 'Loại',
    ...
    quizScope: 'Phạm vi',
    quizScopeAll: 'Tất cả',
    quizScopeRecent7: '7 ngày gần đây',
    quizScopeRecent30: '30 ngày gần đây',
    quizStart: 'Bắt đầu',
    quizNext: 'Tiếp',
    quizResult: 'Kết quả',
    quizRetry: 'Thử lại',
    ...
    guestEntry: 'Trải nghiệm với tư cách khách →',
    guestStartFailed: 'Không thể bắt đầu chế độ khách. Vui lòng thử lại sau ít phút.',
    adLabel: 'Quảng cáo',
    ...
    readingPhotoCaption: 'Hãy chụp từng trang một',
    readingUploadBtn: '📂 Tải ảnh sách lên',
    readingUploadHint: 'Hãy tải lên tất cả ảnh cùng lúc, theo thứ tự trang.\nTrang sẽ hiện theo thứ tự bạn chọn.',
    readingGuestSampleIntro: 'Chưa có ảnh sách?',
    readingGuestSample1: '📥 Ảnh mẫu 1',
    readingGuestSample2: '📥 Ảnh mẫu 2',
    readingExtracting: 'Đang trích xuất văn bản...',
    readingPhaseExtract: 'Đang trích xuất văn bản...',
    readingPhaseStitch: 'Đang sắp xếp ranh giới trang...',
    readingPhaseTranslate: 'Đang tạo tài liệu học tập...',
    readingLoadingGuide: 'Vui lòng không rời khỏi màn hình này cho đến khi xử lý xong',
    readingTranslate: 'Dịch',
    readingShowOriginal: 'Bản gốc',
    readingMaxPagesAlert: 'Bạn có thể tải lên tối đa 30 trang mỗi lần.',
    creditInsufficient: '🪙 Không đủ credit.\nSố dư hiện tại: {balance}\nCần: {needed}',
    readingNoText: 'Không có văn bản đọc được trên trang này.',
    readingPageError: 'Không thể trích xuất văn bản từ trang này.',
    readingRetryPage: 'Thử lại',
    readingReplacePhoto: 'Thay ảnh khác',
    readingRetryingPage: 'Đang thử lại...',
    readingExtractFailedTitle: 'Trích xuất thất bại',
    readingExtractFailedDesc: 'Không thể trích xuất văn bản từ trang {pages}.',
    readingRetryAll: 'Thử lại',
    ...
    readingSaveBookBtn: '📚 Lưu thành sách',
    readingReorderPagesBtn: '🔀 Sắp xếp',
    readingReorderModalTitle: 'Sắp xếp trang',
    readingReorderModalDesc: 'Dùng nút ↑↓ để đổi thứ tự trang',
    readingReorderSaveError: 'Không thể lưu thứ tự mới',
    readingSavedIndicator: 'Sách đã lưu',
    readingSaveBookTitle: 'Lưu sách',
    readingSaveBookDesc: 'Nhập tiêu đề cho sách này',
    readingAutoSavedToast: 'Đã tự động lưu vào My Books.',
    readingRenameBookBtn: '✏️ Đặt tên sách',
    readingRenameBookTitle: 'Đặt tên sách',
    readingSaveBookPlaceholder: 'vd: Hoàng tử bé Chương 1',
    readingFolderLabel: 'Thư mục',
    readingFolderNone: 'Không có thư mục',
    readingFolderCreateNew: '+ Tạo thư mục mới',
    readingFolderNamePlaceholder: 'Tên thư mục mới',
    readingFolderBookCount: '{n} chương',
    readingFolderBack: '← My Books',
    readingFolderEmpty: 'Thư mục này còn trống',
    readingMoveBookTitle: 'Chuyển vào thư mục',
    readingMoveBookBtn: 'Chuyển',
    readingBookCardPages: '{n} trang',
    readingDeleteBookConfirm: 'Xóa sách này?',
    readingDeleteFolderTitle: 'Xóa thư mục',
    readingDeleteFolderBtn: 'Xóa',
    readingDeleteFolderEmptyDesc: 'Xóa thư mục "{name}"?',
    readingDeleteFolderHasBooksDesc: 'Thư mục "{name}" có {n} chương. Bạn muốn làm gì?',
    readingDeleteFolderKeepBooks: 'Chỉ xóa thư mục',
    readingDeleteFolderWithBooks: 'Xóa cả thư mục và chương',
    readingDeleteFolderError: 'Không thể xóa thư mục',
    readingStudyItemsTitle: 'Mục học trên trang này ({n})',
    readingNoStudyItems: 'Không có mục học trên trang này',
    readingLoadingBooks: 'Đang tải danh sách sách...',
  ...
  th: {
    ...
    voteUpThanks: 'ขอบคุณสำหรับความคิดเห็น',
    voteDownThanks: 'ขอบคุณสำหรับความคิดเห็น เราจะตรวจสอบและปรับปรุง',
    ...
    wbSets: 'ชุด',
    wbBooks: '📚 My Books คำ',
    wbBooksEmpty: 'ยังไม่มีหนังสือที่บันทึกไว้',
    wbBookNoStudyItems: 'ไม่มีคำสำหรับเรียนในหนังสือนี้',
    wbBooksBackToList: '← กลับไปยังหนังสือ',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ พิมพ์',
    ...
    quizMyBooksBackToMode: '← เลือกโหมด',
    quizMyBooksDesc: 'เลือกกลุ่มคำ',
    quizMyBooksTooFew: 'คำไม่เพียงพอ (ต้องมีอย่างน้อย 4 คำ)',
    quizMyBooksGuess: 'ทายคำนี้',
    quizType: 'ประเภท',
    quizTypeFeel: 'ทายความรู้สึก',
    quizTypeImage: 'ทายจากภาพ',
    quizCount: 'จำนวนข้อ',
    quizCountUnit: ' ข้อ',
    quizCountAll: 'ทั้งหมด',
    quizScope: 'ช่วง',
    quizScopeAll: 'ทั้งหมด',
    quizScopeRecent7: '7 วันล่าสุด',
    quizScopeRecent30: '30 วันล่าสุด',
    ...
    aboutLink: 'เกี่ยวกับ',
    guestEntry: 'ทดลองในฐานะแขก →',
    guestStartFailed: 'เริ่มโหมดแขกไม่สำเร็จ โปรดลองอีกครั้งในอีกสักครู่',
    adLabel: 'โฆษณา',
    ...
    readingPhotoCaption: 'ถ่ายภาพทีละหน้า',
    readingUploadBtn: '📂 อัปโหลดภาพหนังสือ',
    readingUploadHint: 'อัปโหลดภาพทั้งหมดพร้อมกันตามลำดับหน้า\nหน้าจะเรียงตามลำดับที่คุณเลือก',
    readingGuestSampleIntro: 'ไม่มีรูปหนังสือ?',
    readingGuestSample1: '📥 รูปตัวอย่าง 1',
    readingGuestSample2: '📥 รูปตัวอย่าง 2',
    readingExtracting: 'กำลังแยกข้อความ...',
    readingPhaseExtract: 'กำลังแยกข้อความ...',
    readingPhaseStitch: 'กำลังจัดเรียงขอบหน้า...',
    readingPhaseTranslate: 'กำลังสร้างเนื้อหาการเรียน...',
    readingLoadingGuide: 'โปรดอย่าออกจากหน้านี้จนกว่าจะประมวลผลเสร็จ',
    readingTranslate: 'แปล',
    readingShowOriginal: 'ต้นฉบับ',
    readingMaxPagesAlert: 'อัปโหลดได้สูงสุด 30 หน้าต่อครั้ง',
    creditInsufficient: '🪙 เครดิตไม่เพียงพอ\nยอดคงเหลือปัจจุบัน: {balance}\nต้องการ: {needed}',
    readingNoText: 'หน้านี้ไม่มีข้อความที่อ่านได้',
    readingPageError: 'ไม่สามารถแยกข้อความจากหน้านี้ได้',
    readingRetryPage: 'ลองอีกครั้ง',
    readingReplacePhoto: 'เปลี่ยนรูปภาพ',
    readingRetryingPage: 'กำลังลองอีกครั้ง...',
    readingExtractFailedTitle: 'แยกข้อความไม่สำเร็จ',
    readingExtractFailedDesc: 'ไม่สามารถแยกข้อความจากหน้า {pages} ได้',
    readingRetryAll: 'ลองอีกครั้ง',
    ...
    readingSaveBookBtn: '📚 บันทึกเป็นหนังสือ',
    readingReorderPagesBtn: '🔀 จัดเรียง',
    readingReorderModalTitle: 'จัดเรียงหน้า',
    readingReorderModalDesc: 'ใช้ปุ่ม ↑↓ เพื่อเปลี่ยนลำดับหน้า',
    readingReorderSaveError: 'บันทึกลำดับใหม่ไม่สำเร็จ',
    readingSavedIndicator: 'หนังสือที่บันทึก',
    readingSaveBookTitle: 'บันทึกหนังสือ',
    readingSaveBookDesc: 'ใส่ชื่อสำหรับหนังสือเล่มนี้',
    readingAutoSavedToast: 'บันทึกอัตโนมัติใน My Books แล้ว',
    readingRenameBookBtn: '✏️ ตั้งชื่อหนังสือ',
    readingRenameBookTitle: 'ตั้งชื่อหนังสือ',
    readingSaveBookPlaceholder: 'เช่น เจ้าชายน้อย บทที่ 1',
    readingFolderLabel: 'โฟลเดอร์',
    readingFolderNone: 'ไม่มีโฟลเดอร์',
    readingFolderCreateNew: '+ สร้างโฟลเดอร์ใหม่',
    readingFolderNamePlaceholder: 'ชื่อโฟลเดอร์ใหม่',
    readingFolderBookCount: '{n} บท',
    readingFolderBack: '← My Books',
    readingFolderEmpty: 'โฟลเดอร์นี้ยังว่างอยู่',
    readingMoveBookTitle: 'ย้ายไปโฟลเดอร์',
    readingMoveBookBtn: 'ย้าย',
    readingBookCardPages: '{n} หน้า',
    readingDeleteBookConfirm: 'ลบหนังสือเล่มนี้?',
    readingDeleteFolderTitle: 'ลบโฟลเดอร์',
    readingDeleteFolderBtn: 'ลบ',
    readingDeleteFolderEmptyDesc: 'ลบโฟลเดอร์ "{name}" ?',
    readingDeleteFolderHasBooksDesc: 'โฟลเดอร์ "{name}" มี {n} บท จะทำอย่างไร?',
    readingDeleteFolderKeepBooks: 'ลบเฉพาะโฟลเดอร์',
    readingDeleteFolderWithBooks: 'ลบโฟลเดอร์และบท',
    readingDeleteFolderError: 'ลบโฟลเดอร์ไม่สำเร็จ',
    readingStudyItemsTitle: 'รายการเรียนในหน้านี้ ({n})',
    readingNoStudyItems: 'ไม่มีรายการเรียนในหน้านี้',
    readingLoadingBooks: 'กำลังโหลดรายการหนังสือ...',
  ...
  pt: {
    ...
    voteUpThanks: 'Obrigado pelo seu feedback.',
    voteDownThanks: 'Obrigado pelo seu feedback. Vamos revisar e melhorar.',
    ...
    wbVocab: 'Palavras',
    wbSets: 'Conjuntos',
    wbBooks: '📚 My Books Palavras',
    wbBooksEmpty: 'Ainda não há livros salvos',
    wbBookNoStudyItems: 'Não há palavras de estudo neste livro',
    wbBooksBackToList: '← Voltar para livros',
    wbBookPageHeader: '# {n}',
    wbBookPrintBtn: '🖨️ Imprimir',
    ...
    quizMyBooksBackToMode: '← Modo',
    quizMyBooksDesc: 'Selecione um grupo de palavras',
    quizMyBooksTooFew: 'Poucas palavras (são necessárias ao menos 4)',
    quizMyBooksGuess: 'Adivinhe a palavra',
    quizType: 'Tipo',
    ...
    quizScope: 'Faixa',
    quizScopeAll: 'Tudo',
    quizScopeRecent7: 'Últimos 7 dias',
    quizScopeRecent30: 'Últimos 30 dias',
    quizStart: 'Iniciar quiz',
    quizNext: 'Próximo',
    quizResult: 'Resultado',
    ...
    feedback: 'Feedback',
    aboutLink: 'Sobre',
    guestEntry: 'Continuar como convidado →',
    guestStartFailed: 'Não foi possível iniciar o modo convidado. Tente novamente em um momento.',
    adLabel: 'Publicidade',
    ...
    readingPhotoCaption: 'Fotografe uma página por vez',
    readingUploadBtn: '📂 Enviar fotos do livro',
    readingUploadHint: 'Envie todas as fotos de uma vez, na ordem das páginas.\nAs páginas seguem a ordem em que você as seleciona.',
    readingGuestSampleIntro: 'Sem foto do livro?',
    readingGuestSample1: '📥 Foto de amostra 1',
    readingGuestSample2: '📥 Foto de amostra 2',
    readingExtracting: 'Extraindo texto...',
    readingPhaseExtract: 'Extraindo texto...',
    readingPhaseStitch: 'Organizando os limites das páginas...',
    readingPhaseTranslate: 'Gerando material de estudo...',
    readingLoadingGuide: 'Por favor, permaneça nesta tela até o processamento ser concluído',
    ...
    readingRetryPage: 'Tentar novamente',
    readingReplacePhoto: 'Substituir foto',
    readingRetryingPage: 'Tentando novamente...',
    readingExtractFailedTitle: 'Falha na extração',
    readingExtractFailedDesc: 'Não foi possível extrair o texto das páginas {pages}.',
    readingRetryAll: 'Tentar novamente',
    ...
    readingSaveBookBtn: '📚 Salvar como livro',
    readingReorderPagesBtn: '🔀 Reordenar',
    readingReorderModalTitle: 'Reordenar páginas',
    readingReorderModalDesc: 'Use ↑↓ para mudar a ordem das páginas',
    readingReorderSaveError: 'Falha ao salvar a nova ordem',
    readingSavedIndicator: 'Livro salvo',
    readingSaveBookTitle: 'Salvar livro',
    readingSaveBookDesc: 'Digite um título para este livro',
    readingAutoSavedToast: 'Salvo automaticamente em My Books.',
    readingRenameBookBtn: '✏️ Dar um nome a este livro',
    readingRenameBookTitle: 'Dar um nome a este livro',
    readingSaveBookPlaceholder: 'ex. O Pequeno Príncipe Cap.1',
    readingFolderLabel: 'Pasta',
    readingFolderNone: 'Sem pasta',
    readingFolderCreateNew: '+ Criar nova pasta',
    readingFolderNamePlaceholder: 'Nome da nova pasta',
    readingFolderBookCount: '{n} capítulos',
    readingFolderBack: '← My Books',
    readingFolderEmpty: 'Esta pasta está vazia',
    readingMoveBookTitle: 'Mover para pasta',
    readingMoveBookBtn: 'Mover',
    readingBookCardPages: '{n} páginas',
    readingDeleteBookConfirm: 'Excluir este livro?',
    readingDeleteFolderTitle: 'Excluir pasta',
    readingDeleteFolderBtn: 'Excluir',
    readingDeleteFolderEmptyDesc: 'Excluir a pasta "{name}"?',
    readingDeleteFolderHasBooksDesc: 'A pasta "{name}" contém {n} capítulo(s). O que fazer?',
    readingDeleteFolderKeepBooks: 'Excluir apenas a pasta',
    readingDeleteFolderWithBooks: 'Excluir pasta e capítulos',
    readingDeleteFolderError: 'Falha ao excluir pasta',
    readingStudyItemsTitle: 'Itens de estudo nesta página ({n})',
    readingNoStudyItems: 'Não há itens de estudo nesta página',
    readingLoadingBooks: 'Carregando livros...',
