...
const I18N = {
  ko: {
    ...
    readingFolderEmpty: '이 폴더에 아직 책이 없어요',
    ...
    readingDeleteFolderHasBooksDesc: '폴더 "{name}" 에 책 {n}권이 있어요. 어떻게 할까요?',
    readingDeleteFolderKeepBooks: '폴더만 삭제',
    readingDeleteFolderWithBooks: '책도 함께 삭제',
  ...
  en: {
    ...
    readingDeleteFolderHasBooksDesc: 'Folder "{name}" contains {n} book(s). What do you want to do?',
    readingDeleteFolderKeepBooks: 'Delete folder only',
    readingDeleteFolderWithBooks: 'Delete folder and books',
  ...
  ja: {
    ...
    readingDeleteFolderHasBooksDesc: 'フォルダ「{name}」に本が{n}冊あります。どうしますか?',
    readingDeleteFolderKeepBooks: 'フォルダのみ削除',
    readingDeleteFolderWithBooks: '本も一緒に削除',
  ...
  zh: {
    ...
    readingDeleteFolderHasBooksDesc: '文件夹"{name}"包含{n}本书。如何处理?',
    readingDeleteFolderKeepBooks: '仅删除文件夹',
    readingDeleteFolderWithBooks: '同时删除书籍',
  ...
  es: {
    ...
    readingDeleteFolderHasBooksDesc: 'La carpeta "{name}" contiene {n} libro(s). ¿Qué hacer?',
    readingDeleteFolderKeepBooks: 'Eliminar solo la carpeta',
    readingDeleteFolderWithBooks: 'Eliminar carpeta y libros',
  ...
  vi: {
    ...
    readingDeleteFolderHasBooksDesc: 'Thư mục "{name}" có {n} sách. Bạn muốn làm gì?',
    readingDeleteFolderKeepBooks: 'Chỉ xóa thư mục',
    readingDeleteFolderWithBooks: 'Xóa cả thư mục và sách',
  ...
  th: {
    ...
    readingDeleteFolderHasBooksDesc: 'โฟลเดอร์ "{name}" มีหนังสือ {n} เล่ม จะทำอย่างไร?',
    readingDeleteFolderKeepBooks: 'ลบเฉพาะโฟลเดอร์',
    readingDeleteFolderWithBooks: 'ลบโฟลเดอร์และหนังสือ',
  ...
  pt: {
    ...
    readingDeleteFolderHasBooksDesc: 'A pasta "{name}" contém {n} livro(s). O que fazer?',
    readingDeleteFolderKeepBooks: 'Excluir apenas a pasta',
    readingDeleteFolderWithBooks: 'Excluir pasta e livros',
