...
const I18N = {
  ko: {
    ...
    featureDesc2: '단어는 물론 숙어, 표현, 문장도 AI가 쉽고 자연스럽게 설명해드려요.',
    featureBadge2: '표현 무제한',
    featureTitle3: '모든 언어 통합 검색',
    featureDesc3: '언어를 선택할 필요 없어요. 어떤 언어든 바로 검색하면 됩니다.',
    featureBadge3: '멀티 언어',
    featureTitle4: '검색할 수 있는 표현이 무한해요',
    featureDesc4: 'AI가 실시간으로 설명하기 때문에 사전에 없는 표현도 바로 이해할 수 있어요.',
    featureBadge4: 'AI 실시간',
    confirm: '확인',
    delete: '삭제',
    close: '닫기',
    search: '검색',
    ...
    discoveryNote: '이제 언제든 빠르게 다시 만날 수 있어요',
...
예시: split, break down, take off`,
  ...
  en: {
    ...
    featureDesc2: 'Words, idioms, expressions, and whole sentences — all explained naturally by AI.',
    featureBadge2: 'Unlimited Range',
    featureTitle3: 'Unified Multi-Language Search',
    featureDesc3: 'No need to pick a language. Just type in any language and search.',
    featureBadge3: 'Multilingual',
    featureTitle4: 'Unlimited Expressions to Search',
    featureDesc4: 'AI explains in real time, so even expressions not in any dictionary become clear instantly.',
    featureBadge4: 'AI Real-Time',
    confirm: 'OK',
    delete: 'Delete',
    close: 'Close',
    search: 'Search',
...
Example: split, break down, take off`,
  ...
  ja: {
    ...
    featureDesc2: '単語はもちろん、熟語・表現・文も AI が自然にわかりやすく説明します。',
    featureBadge2: '表現無制限',
    featureTitle3: 'すべての言語を統合検索',
    featureDesc3: '言語を選ぶ必要なし。どんな言語でもそのまま検索できます。',
    featureBadge3: '多言語',
    featureTitle4: '検索できる表現が無限',
    featureDesc4: 'AI がリアルタイムで説明するので、辞書にない表現もすぐわかります。',
    featureBadge4: 'AI リアルタイム',
    confirm: 'OK',
    delete: '削除',
    close: '閉じる',
    search: '検索',
    ...
    discoveryNote: 'これからはいつでもすぐに見つけられます',
...
例：split, break down, take off`,
  ...
  zh: {
    ...
    featureDesc2: '单词、成语、表达和完整句子,AI 都能自然地为你讲解。',
    featureBadge2: '表达无限',
    featureTitle3: '多语言统一检索',
    featureDesc3: '无需选择语言,任何语言都能直接搜索。',
    featureBadge3: '多语言',
    featureTitle4: '可搜索的表达无穷无尽',
    featureDesc4: 'AI 实时解释,字典里没有的表达也能马上看懂。',
    featureBadge4: 'AI 实时',
    confirm: '确认',
    delete: '删除',
    close: '关闭',
...
示例：split, break down, take off`,
  ...
  es: {
    ...
    featureDesc2: 'Palabras, modismos, expresiones y oraciones completas — todo explicado con naturalidad por la IA.',
    featureBadge2: 'Alcance Ilimitado',
    featureTitle3: 'Búsqueda multilingüe unificada',
    featureDesc3: 'No hace falta elegir idioma. Escribe en cualquier idioma y busca.',
    featureBadge3: 'Multilingüe',
    featureTitle4: 'Expresiones infinitas para buscar',
    featureDesc4: 'La IA explica en tiempo real, así que incluso las expresiones que no están en el diccionario quedan claras al instante.',
    featureBadge4: 'IA en Tiempo Real',
    confirm: 'Aceptar',
    delete: 'Eliminar',
    close: 'Cerrar',
    search: 'Buscar',
    ...
    searching1: 'Invocando la palabra...',
    ...
    discoveryNote: 'Ahora puedes encontrarla al instante cuando quieras',
...
Ejemplo: split, break down, take off`,
  ...
  vi: {
    ...
    featureDesc2: 'Từ vựng, thành ngữ, cách diễn đạt và cả câu hoàn chỉnh đều được AI giải thích tự nhiên.',
    featureBadge2: 'Không giới hạn',
    featureTitle3: 'Tìm kiếm đa ngôn ngữ thống nhất',
    featureDesc3: 'Không cần chọn ngôn ngữ. Gõ bất kỳ ngôn ngữ nào và tìm kiếm ngay.',
    featureBadge3: 'Đa ngôn ngữ',
    featureTitle4: 'Vô hạn biểu đạt để tìm kiếm',
    featureDesc4: 'AI giải thích theo thời gian thực nên cả những biểu đạt không có trong từ điển cũng được hiểu ngay.',
    featureBadge4: 'AI thời gian thực',
    confirm: 'Xác nhận',
    delete: 'Xóa',
    close: 'Đóng',
    search: 'Tìm kiếm',
...
Ví dụ: split, break down, take off`,
  ...
  th: {
    ...
    featureDesc2: 'คำศัพท์ สำนวน การแสดงออก และประโยค — AI อธิบายได้อย่างเป็นธรรมชาติ',
    featureBadge2: 'ไม่จำกัด',
    featureTitle3: 'ค้นหาทุกภาษาแบบรวม',
    featureDesc3: 'ไม่ต้องเลือกภาษา พิมพ์ภาษาใดก็ได้แล้วค้นหาเลย',
    featureBadge3: 'หลายภาษา',
    featureTitle4: 'การแสดงออกที่ค้นหาได้ไร้ขีดจำกัด',
    featureDesc4: 'AI อธิบายแบบเรียลไทม์ แม้การแสดงออกที่ไม่มีในพจนานุกรมก็เข้าใจได้ทันที',
    featureBadge4: 'AI เรียลไทม์',
    confirm: 'ตกลง',
    delete: 'ลบ',
    close: 'ปิด',
    search: 'ค้นหา',
...
ตัวอย่าง: split, break down, take off`,
  ...
  pt: {
    ...
    featureBadge2: 'Alcance Ilimitado',
    featureTitle3: 'Busca unificada multilíngue',
    featureDesc3: 'Sem precisar escolher idioma. Digite em qualquer idioma e busque.',
    featureBadge3: 'Multilíngue',
    featureTitle4: 'Expressões infinitas para buscar',
    featureDesc4: 'A IA explica em tempo real, então até expressões que não estão no dicionário ficam claras na hora.',
    featureBadge4: 'IA em Tempo Real',
    confirm: 'OK',
    delete: 'Excluir',
    close: 'Fechar',
    search: 'Buscar',
